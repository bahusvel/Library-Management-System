...
CREATE SEQUENCE "public"."BookLease_lease_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."Book_book_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."Magazine_magazine_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."book_entity_book_entity_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."book_return_book_return_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."item_entity_item_entity_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."item_lease_item_lease_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."item_return_item_return_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."magazine_edition_mag_edition_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE SEQUENCE "public"."member_member_id_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
CREATE TABLE "public"."magazine" (
	...
	"publisher" varchar(2044) NOT NULL COLLATE "default",
	"author" varchar(2044) NOT NULL COLLATE "default",
	"frequency" varchar(2044) NOT NULL COLLATE "default",
	"language" varchar(2044) NOT NULL COLLATE "default",
	"isbn" varchar(2044) NOT NULL COLLATE "default"
)
WITH (OIDS=FALSE);
...
CREATE TABLE "public"."member" (
	"firstname" varchar(2044) COLLATE "default",
	"lastname" varchar(2044) COLLATE "default",
	"dob" date,
...
-- ----------------------------
ALTER SEQUENCE "public"."BookLease_lease_id_seq" RESTART 2 OWNED BY "book_lease"."lease_id";
ALTER SEQUENCE "public"."Book_book_id_seq" RESTART 2 OWNED BY "book"."book_id";
ALTER SEQUENCE "public"."Employee_employee_id_seq" RESTART 2 OWNED BY "employee"."employee_id";
ALTER SEQUENCE "public"."Magazine_magazine_id_seq" RESTART 2 OWNED BY "magazine"."magazine_id";
ALTER SEQUENCE "public"."book_entity_book_entity_id_seq" RESTART 2 OWNED BY "book_entity"."book_entity_id";
ALTER SEQUENCE "public"."book_return_book_return_id_seq" RESTART 2 OWNED BY "book_return"."book_return_id";
ALTER SEQUENCE "public"."item_entity_item_entity_id_seq" RESTART 2 OWNED BY "item_entity"."item_entity_id";
ALTER SEQUENCE "public"."item_item_id_seq" RESTART 2 OWNED BY "item"."item_id";
ALTER SEQUENCE "public"."item_lease_item_lease_id_seq" RESTART 2 OWNED BY "item_lease"."item_lease_id";
ALTER SEQUENCE "public"."item_return_item_return_id_seq" RESTART 2 OWNED BY "item_return"."item_return_id";
ALTER SEQUENCE "public"."magazine_edition_mag_edition_id_seq" RESTART 2 OWNED BY "magazine_edition"."mag_edition_id";
ALTER SEQUENCE "public"."magazine_entity_mag_entity_id_seq" RESTART 2 OWNED BY "magazine_entity"."mag_entity_id";
ALTER SEQUENCE "public"."member_member_id_seq" RESTART 2 OWNED BY "member"."member_id";
-- ----------------------------
